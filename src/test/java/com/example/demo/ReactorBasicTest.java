...
public class ReactorBasicTest {
     ...
     */
    @Test
    public void comparisonToJava8Streams() {
     ...
     */
    @Test
    public void creatingAConnectableFlux() {
    ...
    @Test
    public void combiningTwoStreams() {
        List<String> elements = new ArrayList<>();
        Flux.just(1, 2, 3, 4)
                .log()
                .map(i -> i * 2)
    ...
    @Test
    public void mappingDataInAStream() {
        List<Integer> elements = new ArrayList<>();
        Flux.just(1, 2, 3, 4)
                .log()
                .map(i -> i * 2)
